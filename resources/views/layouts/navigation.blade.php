                ...
                <x-ui.dropdown>
                    ...
                    <x-ui.dropdown-content position="top" align="right" class="w-48">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                        <x-ui.dropdown-link :href="route('logout')" class="hover:bg-destructive/5! hover:text-destructive" onclick="event.preventDefault();
