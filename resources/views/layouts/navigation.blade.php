    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Toggle Dark mode -->
                <x-ui.button aria-label="{{ __('Toggle Dark Mode') }}" size="icon" variant="ghost" class="me-3" @click="$store.darkMode.toggle()">
                    <svg
                ...
                <x-ui.dropdown>
                    ...
                    <x-ui.dropdown-content position="top" align="right" class="w-42">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <x-ui.button aria-label="{{ __('Toggle Dark Mode') }}" size="icon" variant="ghost" class="me-3 bg-transparent" @click="$store.darkMode.toggle()">
                    <svg
                        x-show="!$store.darkMode.on"
                        width="15"
                        height="15"
                ...
                <x-ui.button size="icon" variant="outline" @click="open = ! open">
